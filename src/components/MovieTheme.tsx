      ...
      {visibleThemes.map((items) => (
        ...
        <section className="section">
          <div className="container">
            <div className="row">
              <div className="col-12">
                <h2 className="section__title">{items.theme.name}</h2>
              </div>
              <div className="col-12">
                <div className="section__carousel-wrap">
                       ...
                       {items.data.movies.map((movie) => (
                        <div className="card">
                          <a href="#" className="card__cover">
                            <img src={'https://wsrv.nl/?url=' + movie.image.poster + '&format=webp&quality=50&output=webp'} alt="" />
                  ...
                  <button className="section__nav section__nav--cards section__nav--prev" data-nav="#subscriptions" type="button">
                  ...
                  <button className="section__nav section__nav--cards section__nav--next" data-nav="#subscriptions" type="button">
                    <svg width="17" height="15" viewBox="0 0 17 15" fill="none" xmlns="http://www.w3.org/2000/svg">
