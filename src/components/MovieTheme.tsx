  ...
  return (
    <div className="theme-loader-container">
      {visibleThemes.map((theme) => (
        <div key={theme.theme.id} className="catalog">
            ...
            <div className="row">
              ...
              <div className="row">
                <div className="col-12" style={{ textAlign: 'center', marginTop: '20px' }}>
                  {theme.data.page < theme.data.total_pages && (
                    <button
                      className="catalog__more"
                      type="button"
                      onClick={() => fetchMoreMovies(theme.theme.id, theme.data.page)}>
                      Load more
                    </button>
                  )}
                </div>
