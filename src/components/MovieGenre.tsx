...
export default function MovieGenre({ slug }: MovieGenreProps) {
      ...
      <div className="container">
        <div className="row">
          <div className="col-12 col-xl-6">
            <h1 className="section__title section__title--head">{genre?.name}</h1>
          </div>
          <div className="col-12 col-xl-6">
                        ...
                        <div key={movie.slug} className="col-6 col-sm-4 col-lg-3 col-xl-2">
                            <div className="card">
                                <a href={movie.type == 'single' ? '/movie/' + movie.slug : '/tv-series/' + movie.slug} className="card__cover">
                                    <img src={ "https://wsrv.nl/?url=" + movie.image.poster } alt={movie.origin_name} loading='lazy' decoding='async'/>
